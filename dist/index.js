...
(() => {
  ...
  // src/components/canvasTracking.ts
  ...
  var CanvasTrack, instance;
  var init_canvasTracking = __esm({
    "src/components/canvasTracking.ts"() {
      "use strict";
      init_live_reload();
      init_deviceInfo();
      ...
      CanvasTrack = class {
        ...
        parallaxConfigs = [];
        constructor() {
          this.stage = document.querySelector(".canvas_stage");
        ...
        setupTrackers() {
          this.xTo = gsapWithCSS.quickTo(this.stage, "x", { duration: 1, ease: "power3.out" });
          this.yTo = gsapWithCSS.quickTo(this.stage, "y", { duration: 1, ease: "power3.out" });
        }
        setupParallax() {
          this.parallaxElements.forEach((el) => {
            const container = el.closest(".canvas_img");
            if (!container) return;
            ...
            gsapWithCSS.set(el, { top: "50%", left: "50%", xPercent: -50, yPercent: -50 });
            this.parallaxConfigs.push({
              el,
              container,
              maxX,
              maxY,
              xTo: gsapWithCSS.quickTo(el, "x", { duration: 1.5, ease: "power3.out" }),
              yTo: gsapWithCSS.quickTo(el, "y", { duration: 1.5, ease: "power3.out" })
            });
          });
        }
        startTracking() {
        ...
        kill() {
          this.disable();
          gsapWithCSS.killTweensOf(this.stage);
    ...
    "src/components/modal.ts"() {
      ...
      modal = () => {
        class Modal {
          ...
          deviceTouch;
          constructor() {
            this.modalElement = document.querySelector(".modal_component");
            this.modalBlur = this.modalElement.querySelector(".modal_blur");
            this.layoutModal = this.modalElement.querySelector(".modal_layout");
            this.openModal = document.querySelector("#modalOpen");
  ...
  var gsap2, _fonts, _coreInitted2, _initIfNecessary, _charSegmenter, _toArray, _elements, _emptyArray2, _context2, _spacesRegEx, _emojiSafeRegEx, _emptyBounds, _stretchToFitSpecialChars, _disallowInline, _insertNodeBefore, _getWrapper, _getLineWrapper, _splitWordsAndCharsRecursively, _SplitText, SplitText;
  var init_SplitText = __esm({
    "node_modules/gsap/SplitText.js"() {
      init_live_reload();
      _initIfNecessary = () => _coreInitted2 || SplitText.register(window.gsap);
    ...
    "src/components/preloader.ts"() {
      ...
      preloader = () => {
        class Preloader {
          ...
          max;
          constructor() {
            this.component = document.querySelector(".preload_component");
            this.baseText = this.component.querySelector("#preloaderSplit");
            this.textMask = this.component.querySelector(".preload_text-mask");
  ...
  window.Webflow.push(() => {
    ...
    loadComponent_default(".modal_component", () => Promise.resolve().then(() => (init_modal(), modal_exports)));
    loadComponent_default(".preload_component", () => Promise.resolve().then(() => (init_preloader(), preloader_exports)));
  });
})();
